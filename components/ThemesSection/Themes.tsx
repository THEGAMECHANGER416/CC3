...
const data = [
  {
    serialNo: 1,
    heading: "AI Projects with Exclusive Prize Opportunities",
    description: (
      <>
        Participants can win $100 each for two AI projects, 
        with a chance to compete for the exclusive $50K prize pool available. 
        To be eligible, make sure to register and submit your projects on the{' '}
        <a
          href="https://www.hackquest.io/en/hackathon/explore/Living-Knowledge-Systems-Decentralized-AI-Hackathon"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: 'rgb(27, 89, 160)' }}
        >
          &nbsp; hackathon platform
        </a>
        .
